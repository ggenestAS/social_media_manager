# Bios and descriptions — per platform
...
| Field | Chars | Limit | |
|---|---|---|---|
| Instagram bio · EN | 124 | 150 | ok |
| Instagram bio · FR | 130 | 150 | ok |
| TikTok bio · EN | 72 | 80 | ok |
| TikTok bio · FR | 71 | 80 | ok |
| Facebook intro · EN | 96 | 101 | ok |
| Facebook intro · FR | **104** | 101 | **over — use the trimmed variant below** |
| Facebook about · EN | 251 | 255 | ok |
...
- **Bio · EN**
  ...
  Tell it your exam → daily plan until the door.
  Free early access ↓
  ```
- **Bio · FR**
  ```
  L’IA qui t’entraîne, pas celle qui répond à ta place.
  Ton examen → un plan, chaque jour, jusqu’au jour J.
...
- **About · EN (251):** `Every AI you use does the remembering for you. Albert Prep is the one that gets it into your head: a week-by-week plan built backwards from your exam date, short daily sessions, and feedback on the mistake behind the mistake. Free during early access.`
- **About · FR:** not in the design — write natively before switching the page to French.

## One account, two languages

The accounts are shared FR/UK. The design gives both languages but each
platform holds one bio: pick the primary market's language per platform (the
FR audience is the converted follower base) and put the other language's
one-liner in the pinned post rather than the bio.
