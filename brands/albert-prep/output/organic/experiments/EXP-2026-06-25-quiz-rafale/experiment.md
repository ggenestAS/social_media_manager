...
6. `spe-maths-reflexes-a` — `(x⁴)′`, `ln(e⁷)`, `√169`, `2⁷`, `0,5×0,8` → **published IG+TikTok 27/06 15:03 UTC**
7. `spe-maths-reflexes-b` — `(x⁵)′`, `ln(e⁶)`, `√225`, `3⁴`, `0,2×0,3` — rendered, draft
8. `spe-maths-reflexes-c` — `(x²+5x)′`, `ln(1)`, `√121`, `2⁸`, `1/2+1/3` — rendered, draft
